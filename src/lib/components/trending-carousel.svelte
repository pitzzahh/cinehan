	...
	<div class="grid grid-rows-1 sm:grid-rows-2 md:grid-rows-3">
		...
		<div class="row-start-1 mx-4 h-full text-xl text-white sm:row-start-2 md:row-start-3 md:mt-1">
			...
			<div class="mt-4 flex items-center">
				<Video class="text-theme mr-2 h-5 w-5" />
				<!-- Media Type -->
				<Skeleton class="h-4 w-10 md:h-5 md:w-14" />
				<Star class="text-theme mx-2 h-5 w-5" />
				<!-- Rating -->
				<Skeleton class="h-4 w-10 md:h-5 md:w-14" />
				<Clock class="text-theme mx-2 h-5 w-5" />
				<!-- Runtime -->
				<Skeleton class="h-4 w-10 md:h-5 md:w-14" />
				<Calendar class="text-theme mx-2 h-5 w-5" />
				<!-- Release Data -->
				<Skeleton class="h-4 w-10 md:h-5 md:w-14" />
			</div>
			<Skeleton class="mt-2 h-10 w-auto" />
			<div class="mb-1 mt-4 flex space-x-2 pb-1">
